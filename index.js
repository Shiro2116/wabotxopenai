const sessionName = 'hendi'
const donet = ''
const owner = ['6285156022091']
...
async function startHisoka() {
    ...
    console.log(color(figlet.textSync('WaBot X OpenAI', {
        font: 'Standard',
    ...
    const client = makeWASocket({
        ...
        browser: ['WaBot X OpenAI- AP', 'Safari', '3.0'],
        auth: state
    })
    ...
    client.ev.on('messages.upsert', async chatUpdate => {
        ...
        try {
            ...
            require("./openai")(client, m, chatUpdate, store)
        } catch (err) {
            console.log(err)
        }
    })
